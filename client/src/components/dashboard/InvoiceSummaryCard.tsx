...
type InvoiceSummary = {
  ...
  overdue: number;
  overdueCount: number;
  recentUnpaid: any[];import React, { useEffect, useState } from "react";
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        // Paid this calendar month - use updated_at as proxy for when invoice was marked paid
        ...
        // Recent unpaid - top 3 by created_at desc
