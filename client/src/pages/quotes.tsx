    ...
    return (
      <div className="p-6">
        <Card>
          <CardContent className="text-center py-12">
            <FileText className="mx-auto h-12 w-12 text-gray-400 mb-4" />
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Unable to load quotes</h3>
            <p className="text-gray-600">There was an error loading your quotes. Please try again.</p>
          </CardContent>
        </Card>
      </div>
    );
          ...
          {filteredQuotes.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="mt-1 text-sm text-gray-500">
                {quotes.length === 0 ? "Get started by creating your first quote." : "Try adjusting your search or filter."}
              </p>
            </div>
          ) : (
                  ...
                  {filteredQuotes.map((quote: any) => (
                    <tr key={quote.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        {quote.customer_id || "Not assigned"}
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        {quote.created_at ? new Date(quote.created_at).toLocaleDateString() : "Not available"}
                      </td>
